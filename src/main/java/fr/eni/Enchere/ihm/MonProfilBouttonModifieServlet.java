...
@WebServlet ({"/ProfilUtilisateurbottonModification"})
public class MonProfilBouttonModifieServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/pages/pageProfilBoutton.jsp").forward(request, response);
